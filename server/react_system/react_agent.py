"""ReAct Pattern Agent using LLMClient (adapted from node_agent react_agent.py)."""
...
from react_system.prompts import get_system_prompt
from react_system.progress import make_agent_progress, make_agent_summary
...
class ReactAgent:
    ...
    async def _call_llm(self, messages: List[Dict], *, allow_streaming: bool = False):
        """LLMClient를 사용하여 LLM 호출 (스트리밍 지원).
