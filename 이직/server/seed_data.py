"""
Seed script: Insert initial product data into PostgreSQL.
Usage: DATABASE_URL=... python seed_data.py
...
SEED_PRODUCTS = [
    {
        ...
        "description": {"ko": "4TNV98 엔진 호환", "en": "Compatible with 4TNV98", "cn": "兼容 4TNV98"},
        "category_name": {"ko": "베어링", "en": "Bearing", "cn": "轴承"},
        "detail_info": {
    ...
    },
    {
        ...
        "description": {"ko": "AL-SERIES / AL-PLUS 모델", "en": "AL-SERIES / AL-PLUS", "cn": "AL-SERIES / AL-PLUS"},
        "category_name": {"ko": "플런저", "en": "Plunger", "cn": "柱塞"},
        "detail_info": {
    ...
    },
    {
        ...
        "part_no": "Multi-Brand Parts",
        "price": "문의 (Contact Us)",
        "brand": "Multi-Brand",
        "category": "spare",
        "name": {"ko": "선박 엔진 예비 부품 모음", "en": "Marine Spare Parts (Daihatsu, Yanmar...)", "cn": "船用备件 (Daihatsu, Yanmar...)"},
        "description": {"ko": "다이하츠, 얀마, 한신 등 취급", "en": "Daihatsu, Yanmar, Hanshin etc.", "cn": "Daihatsu, Yanmar, Hanshin 等"},
        "category_name": {"ko": "예비부품", "en": "Spare Parts", "cn": "备件"},
        "detail_info": {
    ...
    },
    {
        ...
        "description": {"ko": "해양 엔진 부품", "en": "Marine Engine Parts", "cn": "船用发动机零件"},
        "category_name": {"ko": "피스톤", "en": "Piston", "cn": "活塞"},
        "detail_info": {
    ...
    },
    {
        ...
        "description": {"ko": "DL22 모델 전용", "en": "For DL22 Model", "cn": "仅限 DL22 型号"},
        "category_name": {"ko": "밸브", "en": "Valve", "cn": "阀门"},
        "detail_info": {
...
async def seed():
    ...
    database_url = "postgresql://postgres:LQOStdUqDdXIyHnBVgwVxrZzDStvyGPD@crossover.proxy.rlwy.net:51581/railway"
    ...
    try:
        ...
        for product in SEED_PRODUCTS:
            ...
            """,
                ...
                json.dumps(product["category_name"], ensure_ascii=False),
                json.dumps(product["detail_info"], ensure_ascii=False),
                json.dumps(product["specs"], ensure_ascii=False),
                json.dumps(product["compatibility"], ensure_ascii=False),
            )
