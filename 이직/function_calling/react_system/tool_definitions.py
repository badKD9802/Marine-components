        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "title": {
                        "type": "string",
                        "description": "삭제할 일정 제목"
                    },
                    "date": {
                        "type": "string",
                        "description": "삭제할 일정 날짜"
                    },
                    "start_time": {
                        "type": "string",
...
결과를 format_meeting_rooms_as_table(meeting_data=결과)로 전달하면 회의실별 접기/펼치기 HTML이 생성됩니다.""",
    ...
    },
    {
        ...
        "function": {
            "name": "draft_document",
            "description": "공식 문서(보고서, 기획서, 제안서 등)의 초안을 작성합니다.",
            "parameters": {
                "type": "object",
                "properties": {
                    "document_type": {
                        "type": "string",
                        "description": "문서 유형 (예: 보고서, 기획서, 제안서, 회의록)"
                    },
                    "title": {
                        "type": "string",
                        "description": "문서 제목"
...
""",
            "parameters": {
                ...
                "properties": {
                    ...
                    "target_language": {
                        "type": "string",
                        "enum": ["영어", "한국어", "일본어", "중국어", "English", "Korean", "Japanese", "Chinese"],
                        "description": "번역할 목표 언어. 예: '영어', 'English', '한국어', 'Korean'"
                    },
                    "source_language": {
                        "type": "string",
                        "enum": ["영어", "한국어", "일본어", "중국어", "English", "Korean", "Japanese", "Chinese", "auto"],
...
**특징:** 날짜별 접기/펼치기, 2열 카드 배치, 회의실별 필터""",
    ...
    },
    {
        ...
        "function": {
            "name": "get_my_team",
            "description": "내 팀원 목록을 조회합니다. 우리 팀에 누가 있는지, 팀장이 누구인지 확인할 수 있습니다.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": []
